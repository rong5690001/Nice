...
package com.nice.ui.capture.camera;
...
import com.nice.ui.capture.config.Config;
...
final class CameraConfigurationManager {
	...
	/**
	 * ´ÓÏà»úÖ§³ÖµÄ·Ö±æÂÊÖÐ¼ÆËã³ö×îÊÊºÏµÄÔ¤ÀÀ½çÃæ³ß´ç
	 * 
	 * @param parameters
	...
	private Point findBestPreviewSizeValue(Camera.Parameters parameters,
		...
		Collections.sort(supportedPreviewSizes, new Comparator<Camera.Size>() {
			...
			public int compare(Camera.Size a, Camera.Size b) {
				...
				//Log.d("jiaojiabin--camera", "aPixels: "+aPixels+",bPixels:"+bPixels);
				if (bPixels < aPixels) {
					return -1;
				}
				if (bPixels > aPixels) {
	...
	/**
	 * ÔÚsupportedValuesÖÐÑ°ÕÒdesiredValues£¬ÕÒ²»µ½Ôò·µ»Ønull
	 * 
